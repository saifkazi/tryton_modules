...
class ServiceOrder(Workflow,ModelSQL, ModelView):
    "Service Order"

    __name__ = 'service.order'
    ...
    @classmethod
    def __setup__(cls):
        super(ServiceOrder, cls).__setup__()
    ...
    def __register__(cls, module_name):
        ...
        super(ServiceOrder, cls).__register__(module_name)
    ...
    def create(cls, vlist):
        ...
        shipments = super(ServiceOrder, cls).create(vlist)
        cls._set_move_planned_date(shipments)
        return shipments

    @classmethod
    def write(cls, *args):
        super(ServiceOrder, cls).write(*args)
    ...
    def copy(cls, shipments, default=None):
        ...
        return super(ServiceOrder, cls).copy(shipments, default=default)
    ...
    def delete(cls, shipments):
        ...
        super(ServiceOrder, cls).delete(shipments)
...
class Purchase(
    ...
    _depends = ['state']
    is_client = fields.Boolean("Client",states={
